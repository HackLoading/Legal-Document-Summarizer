...
# Page config
st.set_page_config(page_title="Legal Text Summarizer (Pegasus)", page_icon="⚖️", layout="wide")

# Title
st.title("⚖️ Legal Text Summarization (Pegasus)")
st.markdown("Summarize legal documents using a fine-tuned Pegasus model.")
